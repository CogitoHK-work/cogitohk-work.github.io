...
export const dict = {
  en: {
    ...
    nav: {
      ...
      joinAsParent: "Book a Parent Session",
      joinUs: "Join Us",
      centres: "Centres",
      menu: "Menu",
    },
    ...
    home: {
      ...
      heroTitleEm: "&nbsp unique learning &nbsp",
      heroTitleEm2: "",
  ...
  zh: {
    ...
    partners: {
      ...
      // Extended content
      intro:
        "香港教育市場正面臨重大轉型。隨著各項人才計劃帶來新家庭湧入，以及對優質課後課程需求的持續增長，市場對卓越教育服務的需求清晰且不斷擴大。這為有熱忱的個人創造了建立成功且有意義事業的獨特機會。",
      reasonsTitle: "為何選擇與 Cogito Education 合作？",
      reasons: [
        {
          title: "經得起市場驗證的成熟系統",
          desc:
            "無需從零開始，便可即時獲取我們經市場驗證、AI 強化的課程體系及營運知識——這些都是在香港多年成功營運中開發及完善的。我們已克服本地化的種種挑戰，您無需重複此過程。不必被準備一切的繁瑣細節所困擾，也無需費心建立自己的教學系統或持續準備教材。您只需專注於拓展業務，其餘由我們為您代勞。",
        },
        {
          title: "低風險、低成本、低門檻",
          desc:
            "我們提供兩種靈活模式：以合作夥伴身份，將我們的高品質內容加入您現有的服務，同時保留原有品牌與運作自由；或以品牌加盟商身份，在我們的全面支援下開設自己的 Cogito 中心。無論哪種模式，均以固定低廉月費起步，即使日後發展壯大，開支亦僅佔收入中很小的一部分。",
        },
        {
          title: "總部全方位支援",
          desc:
            "從第一天起，您絕非孤軍作戰。營運協助：中心設立、牌照申請、招聘及日常管理支援。市場推廣與品牌建立：參與聯合推廣活動，建立強大品牌知名度。培訓與發展：在教學法、科技應用及教學品質方面提供全面培訓，確保團隊成功。",
        },
        {
          title: "以 AI 與科技面向未來",
          desc:
            "在日益受教育科技影響的市場中，我們的課程已透過 AI 優化，以最大化學習效率。加入 Cogito，您不僅進入教育市場，更是投資於這市場的未來——Cogito 將持續升級其系統與教材，緊貼課程與科技的最新發展。",
        },
        {
          title: "有意義的使命",
          desc:
            "這不僅是一門生意，更是一種使命。加入我們，您將成為致力於「以生命影響生命」的社群一員。此理念能引起家長共鳴，並有助於在您的中心周圍建立忠誠的社群。",
        },
        {
          title: "快速回報您的投資",
          desc:
            "在正確的指導及即時可用的成熟課程配合下，您將有很大機會在營運首年達致收支平衡。您仍需在市場推廣方面稍作投資，但我們始終在旁協助。我們的經驗將提升您在合理時間內成功的機率。",
        },
      ],
      idealTitle: "誰是 Cogito 的理想合作夥伴或加盟商？",
      idealLead: "我們正在尋找積極進取、有耐心且充滿熱忱的個人，他們應：",
      idealBullets: [
        "持有高級文憑或以上學歷（適用於加盟商）。",
        "熱衷學習並遵循我們經證實的系統。",
        "希望對下一代產生積極影響。",
      ...
      idealClose:
        "準備好邁出下一步了嗎？如果您對教育充滿熱情並有成功動力，我們期待您的聯繫。這是您以值得信賴的品牌及強大支援體系進入增長市場的機會。立即聯絡我們進行無義務諮詢。",
    },
    ...
    begin: {
      ...
      // Extended content
      whyTitle: "為何為您的孩子選擇 Cogito？",
      whyLead:
        "作為家長，您希望孩子得到的不只是短暫的優異成績。您更希望他們成為自信、獨立的自學者。心態與習慣的改變才會帶來持久的成績，才能在未來以韌性與好奇心應對人生的各種挑戰。以下是 Cogito 與眾不同之處：",
      whyItems: [
        {
          title: "真正的專業，真心的關懷",
          desc:
            "我們的創辦人及導師均為擁有逾多年香港教育經驗的資深教育工作者。他們曾引導及成就數以千計的學生——當中許多人如今已為人父母，也將自己的孩子託付給我們。這份跨世代的信任，是靠實力贏得，而非理所當然的。",
        },
        {
          title: "不止於學術——我們培養自主學習者",
          desc:
            "我們的系統不僅傳授知識，更培養自主學習的習慣。我們不只給答案，更教導孩子如何自己找到答案。當家長問「在家可以做什麼？」時，我們經驗豐富的導師會提供實用且個人化的建議，讓孩子在校外也能強化自主學習的習慣。按照我們的指引認真跟進六個月後，大多數學生不僅在成績上顯著進步，對學習的態度也煥然一新。",
        },
        {
          title: "動力至關重要",
          desc:
            "我們深知，有動力的孩子學習起來事半功倍。我們的日常教學融入鼓勵、正向回饋與真誠的熱忱。我們慶祝進步，而非只追求完美。小班教學（1:3 師生比）讓導師能深入了解每個孩子——他們的優勢、困難及動力來源。",
        },
        {
          title: "成績有目共睹",
          desc:
            "我們的課程不斷以 AI 工具優化，確保其有效性及時代性。更重要的是，我們的學生在校內及公開考試中持續表現卓越，眾多學生升讀頂尖大學。",
        },
        {
          title: "實用建議，即學即用",
          desc:
            "我們的導師不只教導您的孩子，更與您結為夥伴。在定期進度報告中，我們會分享具體策略，讓您在家中也能支援孩子的成長——從推薦讀物到簡單的日常練習，我們讓您成為孩子學習旅程中不可或缺的一部分。",
        },
        {
          title: "共享價值的社群",
          desc:
            "Cogito 不僅是一個品牌或一間補習中心，更是一個以「以生命影響生命」為理念的社群。我們相信培養的不僅是學者，更是善良、有責任感及同理心的個體。",
        },
      ],
      testimonialsTitle: "家長心聲",
      testimonials: [
        {
          quote:
            "「我的女兒以前不喜歡數學。現在她竟會要求『再做一題！』小班教學和老師的耐心關注改變了一切。」",
          author: "九龍，Michelle L. 家長",
        },
        {
          quote:
            "「終於找到一個既能協助校內考試，又能建立真實英語溝通能力的課程。英式發音訓練更是意外收穫！」",
          author: "香港島，David T. 家長",
        },
      ],
    },
