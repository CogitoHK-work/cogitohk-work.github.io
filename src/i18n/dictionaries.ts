...
export const dict = {
  ...
  zh: {
    ...
    home: {
      ...
      nameP1Em: "我思",
      nameP1C:
        "」，正是我們的承諾。在 AI 時代，我們相信真正的學習，源於教育對學習者的主動適應。我們運用科技賦能教師，而非取代他們。透過智能學習分析，我們為每個孩子繪製獨特的學習路徑，讓每堂課都目標清晰、引人入勝，並完美契合其優勢與需求。",
      nameP2:
        "我們不僅教授學科，更培育未來的思考者、問題解決者及自信的溝通者。",
    ...
    programmes: {
      ...
      titleB: "。",
      lead1:
        "我們的教育課程體系由本地教師及專業人士開發，架構由教育專家設計，參考教育局要求並緊貼本地學校實際使用內容。課程涵蓋英語、中文及數學三大主科，適用於 1 至 9 年級，並經 AI 優化以最有效運用學習時間。",
      lead2:
        "每個孩子的潛能各異。為此，夏恩學習法為高度個人化設計。每位學生都有自己的起點(由能力評估決定)及進度規劃，可按個人需求和步調學習。自成立以來，我們系統的成效一直得到持續驗證。",
      highlights: "課程亮點",
      comingSoon: "即將推出：互動式學習",
      comingSoonLead: "請密切留意我們新一代互動課程的公告。",
      list: [
        {
          title: "夏恩幼兒課程",
          age: "3–6 歲",
          intro:
            "為幼稚園學童設計的愉快遊戲式學習，在充滿關愛的小班環境中建立基礎語文、數理、社交技能及雙語自信。",
          body:
            "每週一個半小時的課程結合遊戲時光，涵蓋英、中、數三大主科，為孩子升讀小學做好準備。充足的課程內容讓孩子能自信地適應可能令人卻步的小學生活——對夏恩的孩子而言，這份恐懼不復存在。",
          tracks: [],
          highlights: [
            "基礎語文與數理能力",
            "雙語學習自信",
        ...
        },
        {
          ...
          age: "K1–中三",
          intro:
            "綜合課程，涵蓋英語作為外語學習的所有關鍵元素——詞彙、文法、閱讀、寫作及聆聽，透過系統化的逐步引導完成訓練。",
          body:
            "每個一小時單元包含四個環環相扣的模組，圍繞同一主題。學生可選擇每週一個單元追求效率，或多個單元追求沉浸式學習。預先錄製的母語人士語音培養聆聽、會話及發音能力；中心導師則糾正學習偏差，確保進度穩步向前。",
          tracks: [],
          highlights: [
            "螺旋式學習，強化效果而不流於沉悶重複",
        ...
        },
        {
          ...
          age: "K1–中三",
          intro:
            "如果電腦和 AI 比我們做得更好，孩子還需要學習數學嗎？需要。懂數學並運用機器提升效率的人是機器的主人；不懂的則被機器奴役。",
          body:
            "數學是超越國界的通用語言——理性主義的基礎，也是科學、商業、金融及決策的基本建構塊。我們的課程遵循教育局指引，涵蓋 K1 至中三所有必修課題，以逐步圖解引導學生自主學習，而導師隨時在旁排除障礙。",
          tracks: [
            {
              name: "數學運算",
              desc: "專注於核心運算的速度、準確性及心算敏捷度，提升數學感，適合希望在考試中脫穎而出的學生。",
            },
            {
              name: "數學應用",
              desc: "強調運用所學技能解決現實生活問題，訓練批判性思考及邏輯推理。",
            },
          ],
          highlights: [
            "螺旋式學習，強化效果而不流於沉悶重複",
            "課題劃分為單元，每個單元有核心主題及學習目標",
            "豐富的圖解與示例",
            "問題循序漸進——由基礎到進階",
            "完全對接香港教育局課程",
            "個人化配合個別需求",
        ...
        },
        {
          ...
          age: "K1–中三",
          intro:
            "五千年文化、三千年文字史，使中文成為一門優美卻具挑戰性的語言——即使對母語使用者亦然。我們的綜合課程涵蓋現代中文，並加入文學及文言文。",
          body:
            "每個一小時單元包含四個環環相扣的模組——詞彙、語法、閱讀理解及寫作，圍繞同一主題發展。學生可選擇每週一個單元追求專注高效，或多個單元追求沉浸式學習。中心導師隨時協助有需要的學生，並糾正學習偏差。",
          tracks: [],
          highlights: [
            "螺旋式學習，精心規劃，強化而不重複",
    ...
    advantage: {
      ...
      titleB: " 信任與成果。",
      lead:
        "任何成功課程的關鍵，在於真正理解成為優秀學習者所需的條件，以及贏得家長與學生信任的良好紀錄。夏恩的創辦人擁有四十年教育經驗，曾培育無數學生在公開考試中表現卓越，並進入頂尖大學。",
      principlesTitle: "六大原則，建立值得信賴的品牌。",
      principlesLead: "這些是每一個夏恩課程的根基。",
      principles: [
        "理解將知識轉化為理解，並內化為更多學習基礎所需的所有核心技能。",
        "建立涵蓋本地教育系統所有知識內容的體系。",
        "一套能配合個人需求進行個人化規劃的方法論。",
        "培養學生樂於延續的學習習慣——產生正向回饋並自願持續。",
        "與家長保持良好溝通，讓他們了解學習狀況與進度。",
        "學生優先的文化：成果重於利潤。",
      ],
      classSize: "班級人數",
      classSizeDesc: "每位導師最多學生數",
      featuresTitle: "實踐中——它的真實面貌。",
      features: [
        {
          title: "真正的個人化學習",
          desc: "持續評估帶來的數據洞察，為每個孩子量身打造學習旅程。沒有人被遺忘或限制。",
        },
        {
          title: "親密小班(1:3 師生比)",
        ...
        {
          title: "英式英語根基，本地課程銜接",
          desc: "地道英式英語能力，緊貼香港課程，並融入真實生活情境。",
        },
        {
          title: "成熟優質的原創內容",
        ...
        {
          title: "系統化學習",
          desc: "教材精心規劃，逐步建立基礎，累積知識而不造成沉悶重複。",
        },
        {
          title: "心態塑造",
          desc: "我們的方法強化自主學習能力，並透過正向回饋鼓勵正向思考。",
        },
        {
          title: "全人發展",
          desc: "在培養學術能力的同時，亦培育誠信、同理心及求知慾。",
        },
      ],
    },
    ...
    about: {
      ...
      titleB: "。",
      lead:
        "夏恩教育由兩位擁有四十年教育經驗的資深教育工作者於 2017 年創立。隨著我們終止與英國公司的關聯，品牌重新命名為 Cogito(中文名稱不變)。鑑於今日的科技進步，新身份標誌著我們更聚焦於科技驅動、服務導向及學生為本——一個專注服務香港學生的本土平台。我們的課程已透過 AI 工具進行大幅革新，確保與最新教育趨勢接軌。",
      ...
      grace: {
        ...
        avatar: "蔡",
        paragraphs: [
          "「我擁有超過四十年的教育經驗，曾為中學教師(同時負責校內紀律)，繼而成為某知名跨國教育加盟體系補習中心的負責人兼校長。在成立夏恩前，我在丈夫的幫助下，在該加盟體系(營運遍及 40 個國家)建立了全球最大的教育中心(以學生人數而非面積計)。在那段事業的高峰期，我們中心擁有 3,000 名活躍學生。",
          "那段故事的重點，不在於啟發如何建立一個大商業機構，而是在如何影響學生走上他們需要的道路。在教育行業，如果動機純粹功利，利益反而會遠離。如果動機是為影響下一代成為正直、受尊敬、並願意在需要時伸出援手的人，結果反會超乎想像。",
          "我的理念可以簡潔地以泰戈爾的詩句『以生命影響生命』來概括。",
          "我與丈夫創立了夏恩，是為了擺脫以往的種種限制，實現一個夢想。在夏恩，我們不僅教授知識，更是點亮內在之光。我們幫助每個孩子發現屬於自己的光芒，並將其轉化為對學習的熱情。",
          "好的工作絕不白費。最令我感動的是，我的第一批學生如今已為人父母，他們將自己的孩子也託付給我。這份跨世代的信任，正是我們使命的動力：服務他人、傳播愛、透過與您孩子『共思』的教育創造無可取代的價值。」",
        ],
        signature: "— 蔡老師",
      },
      ...
      hc: {
        ...
        avatar: "馬",
        paragraphs: [
          "「我原是工程師，本該按企業階梯逐步攀升。直到有一天，出於好奇，我決定參與太太的補習中心，看看教育孩子是怎麼一回事。那個決定啟發了我。",
          "就以種樹作為比喻，植物學家會告訴你需要多少陽光、養分和水份，但最好的樹永遠是用心栽種的那棵。三十年前，我決定改變軌道，加入太太的中心，因為我們對能為學生做的事有許多共同願景。從此我一直在這探索之旅上，看著孩子成長是最令人滿足的體驗。",
          "此刻我們創立 Cogito，正值全球充滿混亂，似乎人類必須決定選擇哪條時間線的時刻——前路究竟是充滿黑暗與仇恨，還是光明與互愛。Cogito 的創立正是希望能為後者作出微薄的貢獻。",
          "我深信，即使我們的工作只是滄海一粟，亦無減服務之心。我們希望吸引志同道合者加盟，讓更多人受益。經驗告訴我，只要出發點和動機正確，美好事物總會隨之而來。」",
        ],
        signature: "— 馬老師",
      },
    },
    ...
    partners: {
      ...
      titleB: "。",
      lead1:
        "如果您是有幹勁的個人，不論有無教學經驗，都歡迎以加盟或合作夥伴身份加入我們。兩者門檻均低，但我們會根據候選人的熱誠、能力及實際情況進行篩選。對於有經驗或已正在營運的業者，成為合作夥伴能以非常實惠的固定月費，強化現有營運模式而不造成干擾。",
      lead2:
        "對於希望獲得夏恩總部全面支援的人士，成為加盟商是最有利的選擇。我們通常不會在網上報價，因為條款及條件取決於規模與範圍。面對面會談是唯一的起點，因為我們無意將資料提供給可能隱藏在查詢背後的 AI 機器。",
      partnerSection: "6.1",
      partnerTitle: "夏恩合作夥伴",
      partnerP1:
        "如果您已有正營運中的教育機構，或您本身就是教育工作者，可以以合作夥伴身份加入我們。每月支付固定小額費用，即可獲得部分或全部教學內容(金額視乎機構規模及所需內容)。",
      partnerP2:
        "您可以保留自己的企業身份及名稱。只需在中心店面放置標示，表明自己是夏恩合作夥伴，即可繼續自由經營，並在原有課程外提供我們的課程作為增值選項。",
      partnerNoteLabel: "備註：",
      partnerNote: "合作夥伴需配合驗證您在中心如何使用我們的內容。",

      franchiseeSection: "6.2",
      franchiseeTitle: "夏恩加盟商",
      franchiseeP1:
        "夏恩為加盟商提供由創業至營運各方面的全面支援。無論從零開始或擴展規模，我們將從中心設立、設計、取得牌照、招聘、培訓、市場推廣到教學協助全程支援。您可以從小規模起步但仍可規劃遠大，因為我們可協助設計可擴展的營運模式及良好管理實務。",
      franchiseeP2:
        "成為夏恩加盟商需持有任何學科的高級文憑或以上學歷，但無需有教育經驗。然而，您必須對教學及引導孩子成長充滿熱誠，並具備耐心。",
      franchiseeBenefits: [
        "參與聯合市場推廣及宣傳，提升品牌形象",
        "參與聯合活動，鞏固您作為認可優質中心的地位",
        "日常中心營運的培訓與協助",
        "定期策略會議，共同規劃前進方向",
        "方法論及科技培訓，提升生產力",
        "教育培訓，提升教學品質",
    ...
    begin: {
      ...
      titleB: "。",
      lead:
        "所有父母都希望給予孩子最好的，但要找到良好的教育方法並不容易。我們建議所有認真的家長進行面對面諮詢，尋求可持續的解決方案，而非一次性的考試優異。",
      steps: [
        {
          n: "01",
          title: "參加免費家長諮詢會",
        ...
        },
        {
          n: "02",
          title: "輕鬆的學習能力評估",
          desc: "您的孩子完成具洞察力的入學評估(DT)，協助我們找出最合適的起點。",
        },
        {
          n: "03",
          title: "個人化學習方案",
          desc: "我們會提供一份詳盡、完全針對您孩子優勢與需求的個人化方案。",
        },
        {
          n: "04",
          title: "在小班環境中起步",
