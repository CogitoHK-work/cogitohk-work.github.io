...
const palettes: Palette[] = [
  ...
  {
    id: "green-yellow-indigo",
    name: "Green, Yellow & Indigo",
    description: "Emerald green, golden yellow, deep indigo — fresh, vibrant, and energetic.",
    vars: {
      "--background": "oklch(0.985 0.01 145)",
      "--cream": "oklch(0.97 0.015 100)",
      "--foreground": "oklch(0.2 0.02 260)",
      "--ink": "oklch(0.15 0.03 260)",
      "--card": "oklch(1 0 0)",
      "--card-foreground": "oklch(0.2 0.02 260)",
      "--primary": "oklch(0.35 0.1 155)",
      "--primary-foreground": "oklch(0.99 0 0)",
      "--primary-glow": "oklch(0.7 0.2 75)",
